...
Machine Learning models are still largely superficial -- the models don't really 'understand' the meaning of the sentences they are translating. If we want increasingly 'intelligent' machines, it's important that models begin to incorporate more knowledge of the world.
...
{:.text-center img}
![SGVB]({{ site.url }}/images/fig_1.png "SGVB")
...
{:.text-center img}
![GNMT]({{ site.url }}/images/fig_2.png "GNMT")
...
{:.text-center img}
![GNMT-Multi]({{ site.url }}/images/fig_3.png "GNMT-Multi")
...
{:.text-center img}
![GNMT_vs_GNMT-Multi_1]({{ site.url }}/images/gnmt_vs_gnmt_multi_1.png "GNMT vs. GNMT-Multi (trained with 400,000 sentence pairs)")
...
{:.text-center img}
![GNMT_vs_GNMT-Multi_2]({{ site.url }}/images/gnmt_vs_gnmt_multi_2.png "GNMT vs. GNMT-Multi (trained with 4,000,000 sentence pairs)")
...
{:.text-center img}
![GNMT_vs_GNMT-Multi_vs_GNMT-Multi-SSL_1]({{ site.url }}/images/gnmt_vs_gnmt_multi_vs_gnmt_multi_ssl_1.png "GNMT vs. GNMT-Multi (trained with 400,000 sentence pairs)")

{:.text-center img}
![GNMT_vs_GNMT-Multi_vs_GNMT-Multi-SSL_2]({{ site.url }}/images/gnmt_vs_gnmt_multi_vs_gnmt_multi_ssl_2.png "GNMT vs. GNMT-Multi (trained with 4,000,000 sentence pairs)")
